...
// Function to initialize module names in Student struct
void initialize_module_names(Student* student) {
    for (int i = 0; i < 100; i++) {
        student->highest_module[i] = '\0'; // Set all characters to null terminator
        student->lowest_module[i] = '\0';
    }
}
...
void process_data(Student* students, int num_students) {
    ...
    for (int i = 0; i < num_students; i++) {
        ...
        initialize_module_names(&students[i]); // Initialize module names
